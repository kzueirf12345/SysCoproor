#ifndef SYSCOPROOR_SOURCE_COMMON_INCLUDE_CONCOLE_HPP
#define SYSCOPROOR_SOURCE_COMMON_INCLUDE_CONCOLE_HPP
...
#endif /* SYSCOPROOR_SOURCE_COMMON_INCLUDE_CONCOLE_HPP */